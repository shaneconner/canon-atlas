...
var AtlasLabels = (function () {
  ...
  /* Label level of detail. Every node earns a zoom at which its label becomes
     eligible, ranked once by pagerank and never recomputed: the most central
     documents keep their names at any distance, the rest arrive as you close
     in, so the fit view reads as a sky rather than a wall of text. */
